class ReservasController < ApplicationController
  ...
  def new
    ...
    @reserva.id_usuario = current_user.id
    @reserva.id_cabana = $cabanaid
  ...
  def create
    ...
    @reserva.id_usuario = current_user.id
    @reserva.id_cabana = $cabanaid
    @reserva.nombre_cabana = $cabananombre
  ...
  private
    ...
    def reserva_params
      params.require(:reserva).permit(:id_usuario, :id_cabana, :start_time, :end_time)
    end
end
